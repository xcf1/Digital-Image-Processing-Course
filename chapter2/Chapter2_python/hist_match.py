...
import numpy as np
# 1.59 灰度图像直方图匹配
img = cv2.imread("F:/picture_python/hist_match.png", flags=0)  # flags=0 读取为灰度图像
imgRef = cv2.imread("F:/picture_python/hist_match1.png", flags=0)  # 匹配模板图像, matching template
